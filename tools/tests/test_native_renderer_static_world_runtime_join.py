...
class StaticWorldRuntimeJoinTests(unittest.TestCase):
    ...
    def test_source_contract_has_balanced_static_world_hooks(self):
        ...
        self.assertIn("address = 0x82585F84", analysis)
        self.assertIn("address = 0x82BA61D0", analysis)
        self.assertIn("address = 0x82BA61DC", analysis)
        self.assertIn("ObserveStaticWorldDeferredTaskPublish", hooks)
        self.assertIn("ObserveStaticWorldDeferredTaskCallback", hooks)
        self.assertIn("ObserveStaticWorldDeferredTaskHandoff", hooks)
        self.assertIn("kDeferredSimpleModelTaskVtable = 0x820213B8", hooks)
